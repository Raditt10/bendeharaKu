...
<div class="container">
  ...
  <div class="nav-buttons">
    ...
    <a href="tambah_pengeluaran.php">Tambah data</a>
    <?php endif; ?>
    <a href="data_pengeluaran.php">Muat Ulang</a>
  </div>
  <?php if ($success_msg): ?>
      ...
      if ($result && mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin') {
            echo "<td class='aksi'>
              <a href='edit_pengeluaran.php?id_pengeluaran=" . $row['id_pengeluaran'] . "' style='background:linear-gradient(90deg,#3498db,#f1c40f);'>Edit</a>
              <a href='hapus_pengeluaran.php?id_pengeluaran=" . $row['id_pengeluaran'] . "' style='background:linear-gradient(90deg,#e74c3c,#f1c40f);' onclick=\"return confirm('Yakin ingin menghapus data ini?');\">Hapus</a>
            </td>";
          }
          echo "</tr>";
        }
