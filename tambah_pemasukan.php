...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO pemasukan (bulan, jumlah, keterangan) VALUES ('$bulan', '$jumlah', '$keterangan')";
    if (mysqli_query($koneksi, $query)) {
        session_start();
        $_SESSION['success_msg'] = "Data pemasukan berhasil ditambahkan!";
...
<div class="container">
  ...
  <form method="POST" action="">
    ...
    <input type="text" name="jumlah" required min="0" placeholder="Masukkan jumlah pemasukan">
    <label for="keterangan">Keterangan:</label>
    <textarea name="keterangan" rows="3" required placeholder="Keterangan pemasukan"></textarea>
