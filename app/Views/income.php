...
<style>
    ...
    /* Filter Bar (Desktop) */
    .filter-bar { display: flex; align-items: center; gap: 12px; margin-bottom: 18px; background: #f8fafc; padding: 12px 20px; border-radius: 10px; box-shadow: 0 1px 4px rgba(37,99,235,0.04); width: fit-content; }
    .filter-label { font-weight: 600; color: #2563eb; font-size: 1rem; margin-right: 2px; }
    .custom-dropdown { position: relative; min-width: 110px; user-select: none; }
    .custom-dropdown-selected { font-weight: 600; color: #2563eb; background: #fff; border: 2px solid #2563eb; border-radius: 8px; padding: 8px 36px 8px 16px; font-size: 1.08rem; cursor: pointer; display: flex; align-items: center; justify-content: space-between; }
    .custom-dropdown-list { position: absolute; top: 110%; left: 0; right: 0; background: #fff; border: 2px solid #2563eb; border-radius: 0 0 10px 10px; z-index: 10; max-height: 220px; overflow-y: auto; display: none; }
    .custom-dropdown-item { padding: 10px 18px; font-size: 1.05rem; color: #2563eb; font-weight: 600; cursor: pointer; }
    .custom-dropdown-item:hover { background: #2563eb; color: #fff; }
    .custom-dropdown.open .custom-dropdown-list { display: block; }
    .custom-dropdown-arrow { margin-left: 10px; }
    ...
    @media (max-width: 768px) {
        ...
        /* Filter Wrapper: Compact & Sejajar (jika ada lebih dari 1 filter, di sini hanya Tahun jadi menyesuaikan) */
        .filter-wrapper {
        ...
        /* 2. Tombol Catat (Floating Button) */
        ...
        td.td-amount { 
            ...
            font-size: 1rem; 
            font-weight: 700; 
            color: #10b981 !important; /* Hijau Pemasukan */
        }
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="td-amount" style="color: #10b981; font-weight: 600;">
