...
<style>
    ...
    .btn {
        padding: 10px 18px;
        border-radius: 8px;
        /* <-- Ini yang bikin kotak melengkung sama seperti Expense */
        font-weight: 600;
    ...
    @media (max-width: 992px) {
        ...
        /* Padding bottom agar tidak tertutup tombol floating */
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <?php $bulanSplit = preg_split('/\s+/', $row['bulan']);
                                echo htmlspecialchars($bulanSplit[0]); ?>
                            </td>
                            <?php for ($i = 1; $i <= 4; $i++):
                                $status = $row["minggu_$i"];
                    ...
                    <tr>
                        <td colspan="8" style="padding: 60px 0; text-align: center;">
                            <div style="display:flex; flex-direction:column; align-items:center; gap:12px; opacity:0.7;">
                                <svg width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="var(--gray-300)" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                    <circle cx="12" cy="12" r="10"></circle>
                                    <line x1="12" y1="8" x2="12" y2="12"></line>
                                    <line x1="12" y1="16" x2="12.01" y2="16"></line>
                                </svg>
