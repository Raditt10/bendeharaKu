...
<div class="profile-wrapper">
    <h1 class="profile-header-title reveal fade-up">Profil Saya</h1>

    <div class="profile-card reveal fade-up delay-100">
        ...
        <div class="profile-body">
            ...
            <div class="profile-actions">
                <button class="btn-profile btn-edit" onclick="alert('Fitur Edit Profil sedang dalam pengembangan.');">
