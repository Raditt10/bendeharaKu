    ...
    <div class="form-page-wrapper">
        ...
        <div class="premium-card">
            ...
            <div class="card-body">
                ...
                <h2 class="form-title">Catat Pengeluaran</h2>
                <p class="form-subtitle">Input transaksi uang keluar kas kelas.</p>
                ...
                <form method="POST" action="" id="formExpense" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group-rupiah">
                            ...
                            <input type="text" id="jumlah_display" class="form-input input-no-border" placeholder="0" autocomplete="off" required style="font-size: 1.25rem; font-weight: 800; color: #ef4444;">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="3" class="form-input" placeholder="Contoh: Beli spidol, Fotocopy materi..." required></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div id="customUploadBox" class="custom-upload-box" onclick="document.getElementById('bukti_struk').click();">
                            <div id="uploadPlaceholder">
                                ...
                                <span style="font-weight:700; color:#1e293b; display:block; font-size:1.05rem;">Ketuk untuk upload foto</span>
