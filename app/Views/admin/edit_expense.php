...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    /* CARD STYLES - SAMA PERSIS DENGAN EDIT INCOME */
    ...
    .input-group-rupiah .input-no-border { border: none; box-shadow: none; background: transparent; flex: 1; }
    ...
    <div class="form-wrapper">
        <div class="card">
            <div class="card-header">
                ...
                <p>Perbarui detail transaksi pengeluaran kas.</p>
            </div>
            ...
            <form method="POST" action="" id="formExpense" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-rupiah">
                        ...
                        <input type="text" name="jumlah" id="jumlah_display" class="form-input input-no-border" 
                               placeholder="0" autocomplete="off" required 
                               style="font-size: 1.2rem; font-weight: 700; color: #ef4444;"
                ...
                <div class="form-group">
                    ...
                    <div id="customUploadBox" class="custom-upload-box" onclick="document.getElementById('bukti_struk').click();">
                        ...
                        <div id="uploadPlaceholder" style="display: <?= !empty($data['bukti_foto']) ? 'none' : 'block' ?>;">
                            ...
                            <span style="font-weight:600; color:#1e293b;">Ketuk untuk ganti/upload foto</span>
                    ...
                    <button type="button" id="removeImgBtn" 
                            style="display: <?= !empty($data['bukti_foto']) ? 'inline-block' : 'none' ?>; margin-top:8px; border:none; background:none; color:#ef4444; font-size:0.9rem; cursor:pointer;" 
                            onclick="removeImage()">
                        &times; Hapus Foto / Batal Upload
                    </button>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Inisialisasi tanggal dari Value Hidden Input (Database)
    ...
    function render() {
        ...
        for(let i=0;i<42;i++) {
            if(i < firstDay || day > lastDate) {
                ...
                // Cek apakah tanggal ini sama dengan selected date
    ...
    // Set Initial Display Text based on Database Value
    if(hidden.value) {
...
function previewStruk(event) {
    ...
    if (file) {
        if (file.size > 5 * 1024 * 1024) {
            ...
            removeImage(); // Reset jika oversized
            return;
        }
