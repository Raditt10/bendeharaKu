    ...
    <div class="form-page-wrapper">
        ...
        <div class="premium-card">
            ...
            <div class="card-body">
                ...
                <h2 class="form-title">Edit Data Siswa</h2>
                <p class="form-subtitle">Perbarui informasi anggota kelas XI RPL 1</p>
                ...
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="number" name="nis" class="form-input" placeholder="Contoh: 232410" required value="<?= htmlspecialchars($data['nis']) ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="text" name="nama" class="form-input" placeholder="Nama lengkap sesuai absensi" required style="text-transform: capitalize;" value="<?= htmlspecialchars($data['nama']) ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="number" name="kontak" class="form-input" placeholder="08..." value="<?= htmlspecialchars($data['kontak_orangtua']) ?>">
                        </div>
                        <small style="color: #64748b; font-size: 0.85rem; margin-top: 6px; display: block;">Format angka bebas, sistem akan menyesuaikan secara otomatis.</small>
                    </div>
