    ...
    <div class="form-page-wrapper">
        ...
        <div class="premium-card">
            ...
            <div class="card-body">
                ...
                <h2 class="form-title">Catat Pemasukan</h2>
                <p class="form-subtitle">Input transaksi uang kas masuk / donasi.</p>
                ...
                <form method="POST" action="" id="formIncome">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group-rupiah">
                            ...
                            <input type="text" id="jumlah_display" class="form-input input-no-border" placeholder="0" autocomplete="off" required style="font-size: 1.25rem; font-weight: 800; color: #10b981;">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="keterangan" id="keterangan" rows="3" class="form-input" placeholder="Contoh: Uang Kas Wajib, Donasi, dll..." required></textarea>
                    </div>
