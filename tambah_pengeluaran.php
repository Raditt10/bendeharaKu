...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO pengeluaran (tanggal, jumlah, keterangan) VALUES ('$tanggal', '$jumlah', '$keterangan')";
    if (mysqli_query($koneksi, $query)) {
        session_start();
        $_SESSION['success_msg'] = "Data pengeluaran berhasil ditambahkan!";
...
<div class="container">
  ...
  <form method="POST" action="">
    ...
    <input type="number" name="jumlah" required min="0" placeholder="Masukkan jumlah pengeluaran">
    <label for="keterangan">Keterangan:</label>
    <textarea name="keterangan" rows="3" required placeholder="Keterangan pengeluaran"></textarea>
    <button type="submit" name="submit" class="button-submit">Simpan Data</button>
  </form>
  <a href="data_pengeluaran.php" class="nav-link">&larr; Kembali ke Data Pengeluaran</a>
</div>
</body>
</html>
